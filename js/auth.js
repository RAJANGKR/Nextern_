...
async function handleRegister() {
    ...
    try {
        const response = await fetch(`${window.API_BASE || 'https://nextern-production.up.railway.app'}/api/auth/register`, {
            method: 'POST',
...
function handleGoogleAuth() {
    window.location.href = `${window.API_BASE || 'https://nextern-production.up.railway.app'}/api/auth/google`;
}
